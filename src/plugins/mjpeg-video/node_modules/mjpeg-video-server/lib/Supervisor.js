...
class Supervisor
{
    ...
    run()
    {
        ...
        this.sioAServer.listen( 8090, () =>
        {
            log( "SIO A Server listening on port: 8090\n" );
        });
        ...
        this.sioAServer.on( "connection", client => 
        {
            ...
            client.on( "scan", function(runVideo0, runVideo1)
            {
                ...
                // reset the serial number after each scan
                this.serialNo = 0;
                log( "Scanning sioAServer" );
                this.scanForCameras(runVideo0,runVideo1).then(this.addRemoteCameras(this));
            });
