...
class Supervisor
{
    ...
    run()
    {
        ...
        this.httpAServer.listen( this.settings.port, () =>
        {
        ...
        if (hostname.indexOf("B") === -1) {
           PaddRemoteConnection(this,'8091').then(PaddRemoteListener(this,'8091')).then(PaddRemoteConnection(this,'8092')).then(PaddRemoteListener(this,'8092')).then(this.scanForCameras());
        } else {
           this.scanForCameras();
        }
        ...
        this.sioAServer.on( "connection", client => 
        {
            ...
            client.on( "scan", () =>
            {
                ...
                this.serialNo = 0;
                log( "Scanning" );
                this.scanForCameras().then(this.addRemoteCameras(this));
            });
