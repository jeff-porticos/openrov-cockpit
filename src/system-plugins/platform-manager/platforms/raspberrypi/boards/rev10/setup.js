...
var SetupBoardInterface = function(board) 
{
    ...
    // console.log(`b0be: starting /dev/ttyAMA0`);
    // board.bridge = new SerialBridge( '/dev/ttyAMA0', 115200 );
    // console.log(`b0be: started /dev/ttyAMA0`);

    // Build our socket interface
    console.log(`b0be: starting socket bridge`);
    board.bridge = new ConnectionBridge( 5432 );
    console.log(`b0be: started socket bridge`);
